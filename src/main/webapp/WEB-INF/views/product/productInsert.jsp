       	...
       	<div class="insert-upload-box">
       		<form action="">
	       		...
	       		<div class="box2">
	       			...
	       			<select class="form-select product-category">
	       		...
	       		<div class="box4 d-flex">
	    			...
	    			<div class="flex-box d-flex flex-row m-0">
	       		...
	       		<div class="box5">
	       			...
	       			<textarea class="form-control"placeholder="상품에 대한 설명을 입력하세요"></textarea>
	       		</div>
	       		<div class="box6">
	       			<label for="product-transmethod"><span>거래방식<span class="required">*</span></span></label>
	       			<select class="form-select product-transmethod">

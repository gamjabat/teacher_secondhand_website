...
<script>
	...
	phoneChangeButton.addEventListener('click', () => {
	    ...
	    phoneInput.className = 'change-input form-control';
	    phoneInput.placeholder = '전화번호를 입력하세요';
	
	    // 완료 버튼 생성
	    const phoneCompleteButton = document.createElement('button');
	    phoneCompleteButton.className = 'complete-btn member-info-btn';
	...
	pwChangeButton.addEventListener('click', () => {
	    ...
	    pwInput1.className = 'change-input form-control';
	    ...
	    pwInput2.className = 'change-input form-control';

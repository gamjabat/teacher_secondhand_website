 ...
 */
@WebServlet(name="MypageMyReviewsServlet",urlPatterns = "/member/myreviews.do")
public class MypageMyReviewsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MypageMyReviewsServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Review> reviews  = new ReviewService().getReviewsByMemberNoPaging(param);
        	
        
        
        int totalData = new ReviewService().getReviewsByMemberNoPagingCount(loginMember.getMemberNo());
		...
		request.getRequestDispatcher("/WEB-INF/views/member/mypageMyReviews.jsp")
